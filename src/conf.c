...
static char * default_p1control = "A=J0B0,B=J0B1,C=J0B4,D=J0B5,START=J0B6,COIN=K48,UP=J0a1,DOWN=J0a1,LEFT=J0A0,RIGHT=J0A0,MENU=K27";
//"A=K306,B=K308,C=K32,D=K304,START=K13,COIN=K27,UP=K273,DOWN=K274,LEFT=K276,RIGHT=K275,MENU=K305";
static char * default_p2control = "";
#endif
